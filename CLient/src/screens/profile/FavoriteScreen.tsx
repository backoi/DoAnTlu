    ...
    <View>
      ...
      numColumns={2}
        ...
        renderItem={({ item }) => (
          ...
          <ImageBackground source={{ uri: item.urlImg }} style={{width:width*0.45,height:height*0.3,backgroundColor:'gray',margin:10,justifyContent:'space-between',padding:10,borderRadius:10}}>
           ...
           <View>
              ...
              <Text style={{fontSize:17,color:'white'}}>{item.price}$</Text>
           </View>
          </ImageBackground>
          </TouchableOpacity>
