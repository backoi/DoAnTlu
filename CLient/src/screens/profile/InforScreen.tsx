      ...
      <View>
        ...
        <View>
          ...
          <InputComponent
            leftIC={<AboutMe />}
            onChangeText={(text) =>
              setUserInfor({ ...userInfor, username: text })
            }
          ...
          <InputComponent
            ...
            leftIC={<Phone />}
            onChangeText={(text) => setUserInfor({ ...userInfor, phone: text })}
            value={userInfor.phone}
          ></InputComponent>
          <InputComponent
            leftIC={<Mark />}
            onChangeText={(text) =>
              setUserInfor({ ...userInfor, address: text })
            }
        ...
        <View>
          ...
          <InputComponent
            ...
            onChangeText={(text) =>
              setPasswordInfo({ ...passwordInfo, confirmPassword: text })
            }
