...
const orderSchema = new Schema({
    ...
    status:{type: String, required: true, default: 'OnGoing',enum: ['OnGoing', 'Completed','Cancelled']},
    deliveryAddress: { type: String, required: true},
    paymentStatus: { type: String,enum: ['Pending', 'Paid',], default:'Pending'}, // Pending, Paid, Failed
